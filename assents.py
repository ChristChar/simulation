...
width = 1000
hight = 800
baseDNA = {"cells": [{"organnels": ["ribosoma","ribosoma"], "color": (255, 255, 255), "splitCell": [0, 0], "rotation": [],"MembraneResisten": 1,"divisionDimension": 40}]}
bobDNA = {
    "cells": [
        {
...
SostanzeSpawn = ["glucosio","glucosio","lipidi","Ammoniaca"]
Luce = 50
ossigeno = 20
ChangeLuce = 0.01
waterDirection = 45
